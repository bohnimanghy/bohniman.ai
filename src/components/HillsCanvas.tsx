...
/**
 * Footer "hills" — a Perlin-noise terrain plane rolling toward the camera,
 * rendered as translucent grey ridges that fade into the dark footer.
 * Ported from the design's hillsCanvas (Three.js RawShaderMaterial).
 */
export function HillsCanvas() {
  ...
  useEffect(() => {
    ...
    camera.position.set(0, 16, CAM_Z);
